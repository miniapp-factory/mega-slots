...
- Do not use client hooks such as `useState` and `useEffect` in (page files)[../mini-app/app], move this functionality into a "use client" [component](../mini-app/components).
